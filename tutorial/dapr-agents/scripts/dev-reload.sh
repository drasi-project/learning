...
echo "Reloading Workflow service..."
kubectl delete deployment workflow 2>/dev/null || true
kubectl apply -f services/workflow/k8s/deployment.yaml

echo "Reloading Workflow Dashboard..."
kubectl delete deployment workflow-dashboard 2>/dev/null || true
