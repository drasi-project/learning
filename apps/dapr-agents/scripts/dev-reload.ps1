...
Write-Host "Dapr Agents + Drasi Tutorial - Dev Reload" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
...
Write-Host "Reloading Workflow service..." -ForegroundColor Yellow
kubectl delete deployment workflow 2>$null
kubectl apply -f services/workflow/k8s/deployment.yaml

Write-Host "Reloading Workflow Dashboard..." -ForegroundColor Yellow
kubectl delete deployment workflow-dashboard 2>$null
