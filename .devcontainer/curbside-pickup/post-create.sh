...
kubectl apply -f /workspaces/learning/apps/curbside-pickup/retail_ops/postgres-database.yaml

echo "Waiting for PostgreSQL to become ready..."
kubectl wait --for=condition=ready pod -l app=postgres --timeout=300s

echo "Setting up MySQL for Physical Ops data storage..."
kubectl apply -f /workspaces/learning/apps/curbside-pickup/physical_ops/mysql-database.yaml
